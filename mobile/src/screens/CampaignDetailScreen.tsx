...
export default function CampaignDetailScreen() {
  ...
  async function handleBookWithPin() {
    if (!campaign || !paymentMethod) return;
    ...
    try {
      ...
      await api('/bookings/from-campaign', { method: 'POST', body: JSON.stringify(body) });
      setShowBookModal(false);
      setPaymentMethod(null);
      setNumberOfPeople(1);
      setPin('');
      Alert.alert('Booked', paymentMethod === 'pay_later' ? 'Booking created. Pay in person within 48 hours. Check My Trips and Messages.' : 'Booking created. Check My Trips and Messages for confirmation.');
            ...
            {!paymentMethod ? (
              ...
              <>
                ...
                <View style={styles.modalButtons}>
                  ...
                  <TouchableOpacity style={styles.modalBook} onPress={handleBookWithPin} disabled={booking}>
