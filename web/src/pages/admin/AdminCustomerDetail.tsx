      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-[var(--travel-card-border)] p-6 bg-white/90">
          ...
          <p className="text-xs text-[var(--travel-muted)] mt-3">
            ...
            <strong>Reader still not reachable?</strong> Use the tray app: right‑click the <strong>Travel Wallet NFC Reader</strong> icon in the system tray → <strong>Open admin for NFC linking</strong>. Enter your server API URL once (e.g. <code className="bg-[var(--travel-cream)] px-1 rounded">http://YOUR_SERVER_IP:3000</code>). The admin will open from this PC so the reader works. Or run <code className="bg-[var(--travel-cream)] px-1 rounded">cd web &amp;&amp; npm run dev</code> and open <strong>http://localhost:5173</strong>. You can also paste the UID manually above and click Link card.
          </p>
